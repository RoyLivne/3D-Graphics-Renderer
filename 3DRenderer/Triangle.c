...
//
///////////////////////////////////////////////////////////////////////////////
vect3_t barycentric_weights(vec2_t a, vec2_t b, vec2_t c, vec2_t p) {
	// Find the vectors between the vertices ABC and point p
	vec2_t ac = vect2_subtract(c, a);
	vec2_t ab = vect2_subtract(b, a);
	vec2_t ap = vect2_subtract(p, a);
	vec2_t pc = vect2_subtract(c, p);
	vec2_t pb = vect2_subtract(b, p);
...
vect3_t get_triangle_normal(vec4_t vertices[3])
{
	// Get individual vectors from A, B, and C vertices to compute normal
	vect3_t vector_a = vec3_from_vec4(vertices[0]); /*   A   */
	vect3_t vector_b = vec3_from_vec4(vertices[1]); /*  / \  */
	vect3_t vector_c = vec3_from_vec4(vertices[2]); /* C---B */

	// Get the vector subtraction of B-A and C-A
	vect3_t vector_ab = vect3_subtract(vector_b, vector_a);
	vect3_t vector_ac = vect3_subtract(vector_c, vector_a);
